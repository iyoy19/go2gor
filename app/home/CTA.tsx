  ...
  return (
    <section className="relative font-poppins overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80')" }}
      ></div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 text-center text-black dark:text-white">
        ...
        <motion.p
          className="max-w-2xl mx-auto mb-10 text-lg text-gray-700 dark:text-gray-200 drop-shadow-md"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          viewport={{ once: true }}
        >
          Jangan biarkan lapangan impianmu direbut orang lain. Dengan Go2Gor, booking semudah tap-and-play. Amankan jadwalmu sekarang dan fokus pada kemenangan!
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
